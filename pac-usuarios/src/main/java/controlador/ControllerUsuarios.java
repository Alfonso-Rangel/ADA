...
public class ControllerUsuarios {
     ...
     */
    @PostMapping("/test") // Desde el frontend se usa la ruta http://localhost:8080/usuarios/test para usar este método
    ...
    // En resources/static/test-usuarios.html pueden encontrar un ejemplo de cómo enviar el JSON desde el frontend usando JavaScript.
