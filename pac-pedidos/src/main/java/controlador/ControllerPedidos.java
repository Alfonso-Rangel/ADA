...
public class ControllerPedidos {
     ...
     */
    @PostMapping("/test") // Desde el frontend se usa la ruta http://localhost:8080/pedidos/test para usar este método
    ...
    // En resources/static/test-pedidos.html pueden encontrar un ejemplo de cómo enviar el JSON desde el frontend usando JavaScript.
