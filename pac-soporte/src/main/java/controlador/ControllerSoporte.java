...
public class ControllerSoporte {
     ...
     */
    @PostMapping("/test") // Desde el frontend se usa la ruta http://localhost:8080/soporte/test para usar este método
    ...
    // En resources/static/test-soporte.html pueden encontrar un ejemplo de cómo enviar el JSON desde el frontend usando JavaScript.
